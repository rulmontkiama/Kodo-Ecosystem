...
python -c "import database_manager; database_manager.DB_NAME='kodo_pos.db'; database_manager.initialiser_db()"
...
powershell Compress-Archive -Path dist\Kodo_POS\* -DestinationPath Kodo_POS_v1.0.44_Windows_Portable.zip -Force
