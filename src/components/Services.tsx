...
import { Store, CalendarDays, CheckCircle2, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-foreground/60 max-w-2xl mx-auto font-medium">
            Des outils spécialisés conçus pour répondre aux exigences complexes de votre domaine d'activité.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-black text-foreground mb-4 tracking-tight">Kōdo POS</h3>
              ...
              <ul className="space-y-4 mb-10 text-sm font-bold tracking-wider text-foreground/70">
                ...
                <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-accent" /> Fidélisation client intégrée</li>
              </ul>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-black text-foreground mb-4 tracking-tight">Kōdo Bookings</h3>
              <p className="text-foreground/60 leading-relaxed mb-8 font-medium">
              ...
              <ul className="space-y-4 mb-10 text-sm font-bold tracking-wider text-foreground/70">
                <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-accent" /> Prise de RDV 24/7 en ligne</li>
                <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-accent" /> Rappels SMS automatiques</li>
                <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-accent" /> Plannings collaborateurs</li>
              </ul>
